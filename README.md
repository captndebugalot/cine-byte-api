...
GET    /movies/:id          get one movie with its reviews
...
| Middleware       | `isAuthorized` for authentication, `isAdmin` for role based access                                     |
...
| May 17 - May 21 | Movie model and CRUD routes, isAdmin middleware                                                  |
